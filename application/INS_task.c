/**
  ...
  * 
  *             主要利用陀螺仪 bmi088, 磁力计 ist8310 完成姿态解算，得出欧拉角，
  *             提供通过 BMI088 的 data ready 中断完成外部触发，减少数据等待延迟，
  *             通过DMA的SPI传输节约CPU时间
  * 
  * @note       
  * @history
...
void INS_task(void const *pvParameters)
{
    ...
    //通过函数将 陀螺仪数据 写入变量bmi088_real_data
